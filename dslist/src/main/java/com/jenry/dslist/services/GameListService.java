...
import com.jenry.dslist.repositories.GameListRepository;
...
public class GameListService {
    ...
    public List<GameListDTO> findAll(){
        ...
        return result.stream().map(x -> new GameListDTO(x)).toList(); //transforma um objeto GameList para GameListDTO
    }
